...
% TODO: motivate need for open-source implementations
% TODO: demonstrate an understanding of the full landscape of compression/decompression algorithms, hw solutions, sw solutions, etc
% TODO: convince the reader that Huffman, LZW, and LZ77 were the best and most suitable for open-source hardware implementation and why other algorithms were not chosen

% TODO: Fill out this section to give background on memory limitations, memory compression, limitations, issues, etc. 
...
% TODO: paragraph about using new memory technologies in addition to DRAM. maybe include memristors, MRAM, etc.
\subsection{DRAM Alternative Technologies}\label{ss:dram_alternative_technologies}

% TODO: paragraph about remote RAM sharing, mention infiniswap and other papers
\subsection{Remote Memory Sharing}\label{ss:remote_memory_sharing}

% TODO: paragraph about RAM compression, highlight software implementations, as hardware implementations come later
...
% TODO: start by motivating the need for open-source software with facts and citations. Discuss results, benefitts, impact
% TODO: Discuss the progress of open-source in many communities (SW, HW, etc.)
% TODO: Discuss some HW successes (Simulators like GEM5 & SimpleScalar, open-source FPGA tools like IceStorm, NextPNR, Yosys, Project Trellis, Project Xray, open-source cores like BOOM, Rocket, SweRV, VexRiscv, blackparrot, litex)
% TODO: Discuss some memory successes, as many as possible, convince that the search was exhaustive with citations
% TODO: Use facts to convince reader that no open-source hardware compressors for memory compression and decompression exist
